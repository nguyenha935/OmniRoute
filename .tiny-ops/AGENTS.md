...
13. Full-package chỉ được chép các file runtime mà từng package `@omniroute/*` khai báo trong `package.json.files`; phải loại test/dev residue khỏi các runtime root trước khi tạo payload. Không được nới artifact policy để cho source test lọt vào production.
